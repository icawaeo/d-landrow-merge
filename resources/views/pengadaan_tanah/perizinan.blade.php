<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight flex items-center gap-4">
            ...
            <span>Perizinan untuk Proyek: {{ $proyek->nama_proyek }}</span>
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg">
                <form action="{{ route('pengadaan_tanah.perizinan.store', $proyek->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="p-6 space-y-6">
                        @php
                            $izinList = [
                                ['name' => 'izin_lingkungan', 'label' => 'Izin Lingkungan', 'required' => true],
                                ['name' => 'ikkpr', 'label' => 'IKKPR', 'required' => true],
