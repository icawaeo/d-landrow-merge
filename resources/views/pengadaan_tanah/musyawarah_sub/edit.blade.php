            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form action="{{ route('musyawarah_sub.update', $musyawarah->id) }}" method="POST" enctype="multipart/form-data" class="p-6">
                    ...
                    <div class="flex justify-end mt-6 gap-4">
                        <a href="{{ route('musyawarah_sub.index', ['pengadaanTanah' => $musyawarah->pengadaan_tanah_id]) }}" class="px-6 py-2 bg-gray-300 text-gray-700 font-semibold rounded-md hover:bg-gray-400 text-sm">
                            Batal
                        </a>
