    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">DOKUMEN PEMBAYARAN: {{ $proyek->nama_proyek }}</h2>
            </div>
            <a href="{{ route('pembayaran_sub.create', $proyek->id) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white font-semibold rounded-md hover:bg-blue-700">+ Tambah Data</a>
        </div>
    </x-slot>
