<x-app-layout>
    ...
    @push('content-header')
        <x-content-header
            :proyek="$proyek"
            tahapan="Musyawarah"
            :tambahDataUrl="$isReadOnly ? null : route('row.musyawarah_sub.create', $proyek->id)"
        />
    @endpush
                        ...
                        <table class="min-w-full bg-white">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    {{-- PERUBAHAN DI SINI: Label dikembalikan --}}
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    {{-- Data yang dipanggil tetap 'nama_kecamatan', ini sudah benar --}}
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        @if(!$isReadOnly)
                                            <div class="flex gap-2">
                                                <a href="{{ route('row.musyawarah_sub.edit', $item->id) }}" class="text-gray-600 hover:text-blue-800 p-1" title="Ubah">
                                                ...
                                                <form class="form-hapus" action="{{ route('row.musyawarah_sub.destroy', $item->id) }}" method="POST" data-nama="{{ $item->nama_kecamatan }}">
                                                    @csrf
                                                    @method('DELETE')
