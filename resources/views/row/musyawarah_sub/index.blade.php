<x-app-layout>
    @push('content-header')
        <x-content-header
            :proyek="$proyek"
            tahapan="Musyawarah"
            :tambahDataUrl="route('row.musyawarah_sub.create', $proyek->id)"
        />
    @endpush
                        ...
                        <table class="min-w-full bg-white">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4">
                                        @if($item->file_berita_acara)
                                        <a href="{{ Storage::url($item->file_berita_acara) }}" target="_blank" class="text-blue-600 hover:underline">Lihat Dokumen</a>
                                        @else
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center gap-4">
                                            <a href="{{ route('musyawarah_sub.edit', $item->id) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
